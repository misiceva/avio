...
export class changeReservationFkToCascade1644427512972 implements MigrationInterface {
    name = 'changeReservationFkToCascade1644427512972'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`flight\` CHANGE \`airplaneId\` \`airplaneId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`reservation\` ADD CONSTRAINT \`FK_0b1bd44b024df6ec6593dea5f34\` FOREIGN KEY (\`flightId\`) REFERENCES \`flight\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`reservation\` DROP FOREIGN KEY \`FK_529dceb01ef681127fef04d755d\``);
        await queryRunner.query(`ALTER TABLE \`reservation\` DROP FOREIGN KEY \`FK_0b1bd44b024df6ec6593dea5f34\``);
        await queryRunner.query(`ALTER TABLE \`flight\` CHANGE \`airplaneId\` \`airplaneId\` int NULL DEFAULT 'NULL'`);
